...
public class PercolationStats {
    ...
    public PercolationStats(int N, int T) {
        ...
        for (int i = 0; i < T; i++) {
            ...
            // StdOut.println(String.format("opened %d perc.thresh. %f", opened,
            // pt));
            threshold[i] = pt;
        }
    ...
    public static void main(String[] args) {
        ...
        StdOut.println(String.format(
                "PercolationStats - %d experiments of size %d", n, t));
        ...
        StdOut.println(String.format("confidence interval: [%f, %f]",
